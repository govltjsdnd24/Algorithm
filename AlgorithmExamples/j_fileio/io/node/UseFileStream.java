...
//         System.out.printf("buffer size: %d, time: %d%n", 1000, st.fileMove(1000));
    ...
    private void testFile() throws IOException {
        ...
        File readMe= new File("D:\\ssafy10th\\02-Camp\\02-java\\ssafy_java_10th\\src\\com\\ssafy\\j_fileio\\io\\node\\readme.txt");
        //  프로젝트 내부에서 파일을 찾을 때
    ...
    public long fileMove(int bufferSize) {
        ...
        File src = new File("c:\\ssafyTools\\eclipse-jee-2019-09-R-win32-x86_64.zip");
